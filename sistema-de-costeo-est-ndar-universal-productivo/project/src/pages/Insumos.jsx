// CosteoUniversal — Gestión de Insumos
const { useState, useRef, useEffect } = React;

const INSUMOS_MOCK = [
  { id: 'i1',  nombre: 'Leche entera',        sku: 'INS-001', categoria: 'Lácteos',      unidad: 'L',   precio: 4.80,   proveedor: 'Coboce',      tipo: 'variable', usos: 3 },
  { id: 'i2',  nombre: 'Cuajo enzimático',     sku: 'INS-002', categoria: 'Aditivos',     unidad: 'kg',  precio: 420.00, proveedor: 'TecnoLácteos',tipo: 'variable', usos: 2 },
  { id: 'i3',  nombre: 'Sal refinada',         sku: 'INS-003', categoria: 'Aditivos',     unidad: 'kg',  precio: 8.50,   proveedor: 'Salinas Uyuni',tipo:'variable', usos: 4 },
  { id: 'i4',  nombre: 'Cloruro de calcio',    sku: 'INS-004', categoria: 'Aditivos',     unidad: 'kg',  precio: 95.00,  proveedor: 'TecnoLácteos',tipo: 'variable', usos: 2 },
  { id: 'i5',  nombre: 'Empaque film',         sku: 'INS-005', categoria: 'Empaques',     unidad: 'u',   precio: 0.80,   proveedor: 'Plastibol',   tipo: 'variable', usos: 5 },
  { id: 'i6',  nombre: 'Etiquetas adhesivas',  sku: 'INS-006', categoria: 'Empaques',     unidad: 'u',   precio: 0.35,   proveedor: 'Grafimundo',  tipo: 'variable', usos: 5 },
  { id: 'i7',  nombre: 'Detergente industrial',sku: 'INS-007', categoria: 'Limpieza',     unidad: 'L',   precio: 28.00,  proveedor: 'Química Beni',tipo: 'fijo',     usos: 0 },
  { id: 'i8',  nombre: 'Fermento láctico',     sku: 'INS-008', categoria: 'Aditivos',     unidad: 'g',   precio: 850.00, proveedor: 'TecnoLácteos',tipo: 'variable', usos: 1 },
  { id: 'i9',  nombre: 'Gas GLP',              sku: 'INS-009', categoria: 'Energía',      unidad: 'm³',  precio: 4.20,   proveedor: 'YPFB',        tipo: 'variable', usos: 0 },
  { id: 'i10', nombre: 'Aceite lubricante',    sku: 'INS-010', categoria: 'Mantenimiento',unidad: 'L',   precio: 65.00,  proveedor: 'Castrol',     tipo: 'fijo',     usos: 0 },
  { id: 'i11', nombre: 'Caja cartón 500g',     sku: 'INS-011', categoria: 'Empaques',     unidad: 'u',   precio: 1.20,   proveedor: 'Plastibol',   tipo: 'variable', usos: 3 },
  { id: 'i12', nombre: 'Ácido láctico',        sku: 'INS-012', categoria: 'Aditivos',     unidad: 'kg',  precio: 180.00, proveedor: 'Química Beni',tipo: 'variable', usos: 1 },
];
