    ...
    if (subPage === 'cuenta') return (
      <div>
        ...
        <FieldRow label="Nombre completo">
          <input defaultValue="Admin" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border-subtle)', borderRadius: '6px', color: 'var(--text-primary)', padding: '8px 12px', fontSize: '14px', outline: 'none', fontFamily: 'var(--font-sans)', width: '100%' }}
            onFocus={e => e.target.style.borderColor = accentColor} onBlur={e => e.target.style.borderColor = 'var(--border-subtle)'}
          />
        </FieldRow>
        <FieldRow label="Email">
          <input defaultValue="admin@costeo.bo" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border-subtle)', borderRadius: '6px', color: 'var(--text-primary)', padding: '8px 12px', fontSize: '14px', outline: 'none', fontFamily: 'var(--font-sans)', width: '100%' }}
            onFocus={e => e.target.style.borderColor = accentColor} onBlur={e => e.target.style.borderColor = 'var(--border-subtle)'}
          />
        </FieldRow>
